...
public class RoomManagementController {
    ...
    private void getCurrentrTId() throws SQLException, ClassNotFoundException {
        String currentrTypeId = roomTypeBO.getCurrentTypeId();
    ...
    private void setAll() throws SQLException, ClassNotFoundException {
        ...
        List<RoomTypeTm> list = roomTypeBO.getAll();
    ...
    public void handleRemoveRoom(ActionEvent actionEvent) throws SQLException, ClassNotFoundException {
        String roomNumber = removeRoomNumberField.getText();

        boolean isDeleted = roomTypeBO.delete(roomNumber);
    ...
    public void handleAddRoomType(ActionEvent actionEvent) throws SQLException, ClassNotFoundException {
        ...
        if (isValid()){
            ...
            boolean isSave = roomTypeBO.save(roomTypeDTO);
    ...
    public void handleUpdate(ActionEvent actionEvent) throws SQLException, ClassNotFoundException {
        ...
        boolean isUpdate = roomTypeBO.update(roomTypeDTO);
        if (isUpdate) {
